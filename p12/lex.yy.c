...
static const flex_int16_t yy_base[21] =
    {   0,
       16,   15,   19,   22,    0,   14,    5,   13,   11,   10,
        0,    0,    0,    0,    0,   22,   10,   12,    1,    0
    } ;

static const flex_int16_t yy_def[21] =
    {   0,
       17,   17,   16,   16,   16,   18,   16,   18,    8,    7,
       10,   19,    7,   20,   20,    0,   16,   16,   16,   16
    } ;

static const flex_int16_t yy_nxt[28] =
    {   0,
       16,   15,   12,    6,    7,   10,   11,   12,   10,   13,
        4,    4,    8,    8,   10,   14,    9,    9,   16,    5,
        5,    3,   16,   16,   16,   16,   16
    } ;

static const flex_int16_t yy_chk[28] =
    {   0,
        0,   20,   19,    5,    5,    7,    7,    7,    7,    7,
       17,   17,   18,   18,   10,    9,    8,    6,    3,    2,
        1,   16,   16,   16,   16,   16,   16
    } ;
